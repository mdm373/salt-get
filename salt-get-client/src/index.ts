...
program.command('run')
  ...
  .option('-x, --awsKey [s]', 'aws key credential for push. defaults to env variable AWS_KEY')
  .option('-X, --awsSecret [s]', 'aws secret credential for push. defaults to env variable AWS_SECRET')
